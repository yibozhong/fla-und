...
def get_args():
    ...
    parser.add_argument('--model_type', type=str, default='transformer',
                        choices=['deltanet', 'abc', 'gated_deltanet', 'bitnet', 'gla', 'gsa', 
                                'hgrn', 'hgrn2', 'lightnet', 'linear_attn', 'retnet', 
                                'rwkv6', 'rwkv7', 'transformer', 'nsa'],
    ...
    parser.add_argument('--head_dim', type=int, default=None,
                        help='Dimension of each attention head (for gated_deltanet)')
    ...
    parser.add_argument('--attn_layers', type=str, default='0,1,2,3',
                        help='Comma-separated list of attention layers')
    parser.add_argument('--attn_num_heads', type=int, default=8,
                        help='Number of attention heads')
    parser.add_argument('--attn_num_kv_heads', type=int, default=8,
                        help='Number of key/value heads')
    parser.add_argument('--attn_window_size', type=int, default=7,
                        help='Attention window size')
    parser.add_argument('--attn_block_size', type=int, default=16,
                        help='Attention block size')
    parser.add_argument('--attn_topk', type=int, default=None,
                        help='Top-k attention')
    parser.add_argument('--attn_block_counts', type=int, default=None,
                        help='Number of attention blocks')
    parser.add_argument('--attn_stride', type=int, default=None,
                        help='Attention stride')
    parser.add_argument('--attn_chunk_size', type=int, default=None,
                        help='Attention chunk size')
    parser.add_argument('--attn_mode', type=str, default='normal',
                        help='Attention mode')
    parser.add_argument('--attn_type', type=str, default='normal',
    ...
    parser.add_argument('--compress_attention', action='store_true',
                        help='Whether to compress attention')
    parser.add_argument('--fuse_cross_entropy', action='store_true',
                        help='Whether to fuse cross entropy')
    parser.add_argument('--scan_type', type=str, default='normal',
                        help='Scan type for training')
